...
if __name__ == "__main__":
    # Testar o template original
    original_path = r"c:\Projetos\Poppnet\sreadmin\painel\templates\admin\painel\starlink\dashboard.html"
    print("=== TEMPLATE ORIGINAL ===")
    analyze_template_blocks(original_path)
    
    # Testar o template corrigido
    fixed_path = r"c:\Projetos\Poppnet\sreadmin\painel\templates\admin\painel\starlink\dashboard_fixed.html"
    print("\n=== TEMPLATE CORRIGIDO ===")
    analyze_template_blocks(fixed_path)
